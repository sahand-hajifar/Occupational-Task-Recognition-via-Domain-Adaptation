...
#subject_numbers = c(23,28,29,32,34)
...
# Feature Extraction
In this section, discrete wavelet transform (DWT) is applied to the acceleration data (aX, aY and aZ) in  4-second and 10-second time windows (numVars is the number of observations per window).
```{r feature_extract}
...
numVars = 320 # we can change that (number of datapoints per window)
